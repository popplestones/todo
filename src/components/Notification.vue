          ...
          <div class="p-4">
            <div class="flex items-start">
              <div class="flex-shrink-0">
                ...
                <ExclamationCircleIcon v-if="type === 'error'" class="h-6 w-6 text-red-400" aria-hidden="true" />
                <InformationCircleIcon v-if="type === 'info'" class="h-6 w-6 text-gray-400" aria-hidden="true" />
              </div>
...
import { CheckCircleIcon, InformationCircleIcon, ExclamationCircleIcon, XMarkIcon } from "@heroicons/vue/20/solid";
